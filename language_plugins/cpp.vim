...
function CppPlugin()
	...
	call cpp_stdlib.addImports('unordered_map', [ 'unordered_map', 'unordered_multimap' ])
	call cpp_stdlib.addImports('unordered_set', [ 'unordered_set', 'unordered_multiset' ])
	...
	call cpp_stdlib.addImports('condition_variable', [ 'condition_variable', 'condition_variable_any' ])
